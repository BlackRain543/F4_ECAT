...
------
--------------------------------------------------------------------------------------*/
#include "../../SSC/Inc/ecat_def.h"
#if EL9800_HW

#include "../../SSC/Inc/ecatslv.h"

#define    _EL9800HW_ 1
#include "../../SSC/port/el9800hw.h"
#undef    _EL9800HW_
/* ECATCHANGE_START(V5.11) ECAT10*/
/*remove definition of _EL9800HW_ (#ifdef is used in el9800hw.h)*/
/* ECATCHANGE_END(V5.11) ECAT10*/

#include "../../SSC/Inc/ecatappl.h"
//#include "system.h"
...
#if ECAT_TIMER_INT
//#define 	ECAT_TIMER_ACK_INT		__HAL_TIM_CLEAR_IT(&htim2, TIM_IT_TRIGGER)
#define 	ECAT_TIMER_ACK_INT		__HAL_TIM_CLEAR_FLAG(&htim2, TIM_FLAG_UPDATE)
