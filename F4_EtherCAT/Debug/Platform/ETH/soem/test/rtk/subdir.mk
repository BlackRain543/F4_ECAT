...
C_SRCS += \
../Platform/ETH/soem/test/rtk/main.c 

C_DEPS += \
./Platform/ETH/soem/test/rtk/main.d 

OBJS += \
./Platform/ETH/soem/test/rtk/main.o 


# Each subdirectory must supply rules for building sources it contributes
Platform/ETH/soem/test/rtk/%.o: ../Platform/ETH/soem/test/rtk/%.c Platform/ETH/soem/test/rtk/subdir.mk
