...
void AX58100::EscInit (const esc_cfg_t * config)
{
//   rst_setup();
//   rst_high();
//   spi_setup();
...
void AX58100::EscAddress (uint16_t address, uint8_t command)
{
   /* address 12:5 */
 ...
 */
void AX58100::EscRead (uint16_t address, void *buf, uint16_t len)
{
 ...
 */
void AX58100::EscWrite (uint16_t address, void *buf, uint16_t len)
{
	/* Select device. */
	cs_.Select();
 ...
 */
void AX58100::EscInterruptEnable (uint32_t mask)
{
	// PDI interrupt
	spiIrq_.EnableExit();
 ...
 */
void AX58100::EscInterruptDisable (uint32_t mask)
{
	spiIrq_.DisableExit();
...
void AX58100::TaskDelay(uint32_t time_us)
{
